...
void sort_stream(std::istream & input, const bool reverse, const bool unique, const bool ignore, const bool numeric, const bool stable)
{
    // calculate size
...
int main(int argc, char ** argv)
{
    ...
    if (input_name != nullptr) {
        ...
        sort_stream(f, reverse, unique, ignore, numeric, stable);
    }
    else {
        sort_stream(std::cin, reverse, unique, ignore, numeric, stable);
    }
}